...
\cventry
  ...
  Main achievements:
    \begin{itemize}%
    \item Played instrumental role in shaping our new Test Driven philosophy, having created a \href{https://github.com/shazam/gwen}{library}\superscript{2} that enables us to write our own domain specific language that describes our acceptance tests.
    \item Have been actively involved in our recruitment process, attending many recruiting events, conference talks promoting the company, preparing interview questions and online tests and finally interviewing candidates.
    \item Promoted inter-team communication and code sharing (mainly through the DSL library which is now the de-facto way of writing acceptance tests for all the Java teams in Shazam)
    \item Involved heavily in the complete rewrite of the Shazam application to use the latest Android API's, heavily re-factoring our code base to increase modularity and decrease dependencies. This was also a complete redesign of the app with tablet support.
    \item Have also taken the responsibility of leading the team in the absence of our regular team lead, making sure the developers did not have any issues blocking their every day work, managing expectations of our stakeholders while trying to release a major rewrite with a tight deadline.
    \end{itemize}
    \emph{Technologies used: \textbf{Java, Android, Maven, git, SQLite, TDD, Gwen}}\newline{}%
    \emph{Supporting software used: \textbf{IntelliJ, Jenkins, Jira, Fisheye, Sonar}}
  }
...
\cventry
  ...
  { 
    ...
    Forked and contributed to android open source project \href{https://github.com/shazam/robolectric}{Robolectic}\superscript{3}\newline{}%
    \emph{Technologies used: \textbf{Java, Android, Maven, git, SQLite, TDD, C++, regex, JBehave}}\newline{}%
    \emph{Supporting software used: \textbf{IntelliJ, Bamboo, Jenkins, Jira, Fisheye, Sonar}}
  }
  
\cventry
  {01/2009-04/2011}
  {Software Engineer}
  {\href{www.hamptondata.com}{Hampton Data Services}\superscript{4}}
  {London}
  {}
  {  
...
\cventry
  ...
  {\href{www.eglobal.gr}{eGlobal Internet Stations}\superscript{5}}
  {Thessaloniki}
  {}
  {
    Responsibilities:%
...
\urlfootnote{2}{https://github.com/shazam/gwen}
\urlfootnote{3}{https://github.com/shazam/robolectric}
\urlfootnote{4}{http://www.hamptondata.com}
\urlfootnote{5}{http://www.eglobal.gr}

% hack to get space between page footnotes and bottom info panel
\blfootnote{}

\section{Programming/Scripting Languages}
\cvitem{Java}{11 years}
...
\conference{15/06/2013}{GoogleIO}{https://developers.google.com/events/io}
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ullamcorper neque sit amet lectus facilisis sed luctus nisl iaculis. Vivamus at neque arcu, sed tempor quam. Curabitur pharetra ti

Suspendisse commodo, massa eu congue tincidunt, elit mauris pellentesque orci, cursus tempor odio nisl euismod augue. Aliquam adipiscing nibh ut odio sodales et pulvinar tortor laoreet. Mauris

Duis sit amet magna ante, at sodales diam. Aenean consectetur porta risus et sagittis. Ut interdum, enim varius pellentesque tincidunt, magna libero sodales tortor, ut fermentum nunc metus a a
